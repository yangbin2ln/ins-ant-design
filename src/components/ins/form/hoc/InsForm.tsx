...
class ReactCom extends React.Component<any, any> {
  ...
  constructor(props: any) {
    ...
    var hoc = props.hoc;
    hoc.view = this;
    console.log('constructor', props, this, hoc, this.getForm());
  }
  ...
  render() {
    ...
    const hoc = this.props.hoc;
    const FormItem = Form.Item;
    const formProps = { ...ReactCom.defaultFormProps, ...hoc.config };
    ...
    for (let m = 0; m < formProps.fields.length; m++) {
      ...
      formFields.push((
        <Col key={m} {...this.getColLayout(formProps.columnSize, field.span)}>
...
export default HocFactory(WrappedInsForm);